...
export default function ProductPage() {
  return (
    <div className="hero min-h-screen flex flex-col items-center text-center bg-gray-100 py-[7rem] px-4 md:px-8 lg:px-16">
      <h1 className="text-4xl font-bold text-gray-800 mb-8">Our Product</h1>
